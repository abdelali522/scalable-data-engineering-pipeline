...
bronze_base_dir= project_root/ "data-lake" / "raw" /"ecommerce" / "items"
silver_base_dir= project_root / "data-lake" / "staging" / "ecommerce" / "items"
...
output_file= silver_base_dir/ "items_silver.parquet"
