...
bronze_base_dir= project_root/ "data-lake" / "raw" /"ecommerce" / "categories"
silver_base_dir= project_root / "data-lake" / "staging" / "ecommerce" / "categories"
...
output_file= silver_base_dir/ "categories_silver.parquet"
