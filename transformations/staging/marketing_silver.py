...
raw_base_dir= project_root / "data-lake" / "raw" / "marketing"
silver_base_dir= project_root /"data-lake" / "staging" / "marketing"
...
output_file= silver_base_dir/ "marketing_silver.parquet"
