...
bronze_base_dir= project_root / "data-lake" / "raw" / "ecommerce" / "customers"
silver_base_dir= project_root / "data-lake" / "staging" / "ecommerce" / "customers"
...
output_file= silver_base_dir/ "customers_silver.parquet"
