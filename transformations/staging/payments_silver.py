...
bronze_base_dir= project_root/ "data-lake" / "raw" /"ecommerce" / "payments"
silver_base_dir= project_root / "data-lake" / "staging" / "ecommerce" / "payments"
...
output_file= silver_base_dir/ "payments_silver.parquet"
