...
bronze_base_dir= project_root/ "data-lake" / "raw" /"ecommerce" / "reviews"
silver_base_dir= project_root / "data-lake" / "staging" / "ecommerce" / "reviews"
...
output_file= silver_base_dir/ "reviews_silver.parquet"
